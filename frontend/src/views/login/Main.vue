<template>
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
          <div class="my-auto">
            <img
              ...
              width="100"
              height="100"
              class="-intro-x w-1/2 -mt-16 fill-[#CDA562] hidden dark:block ml-8"
            ...
            <img
              ...
              width="100"
              height="100"
              class="-intro-x w-1/2 -mt-16 fill-white block dark:hidden ml-8"
              src="@/assets/images/logo.svg"
            />
            <div
              class="intro-x font-philosopher text-white dark:text-[#CDA562] font-medium -ml- text-4xl leading-tight mt-10"
            >
              <b>Amanah Sejahtera Bersama</b>
            </div>
          </div>
        </div>
        <!-- END: Login Info -->
          ...
          >
            ...
            <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">
              ...
              <span class="font-philosopher text-[#CDA562] drop-shadow-2xl">
                <b>Amanah Sejahtera Bersama</b> </span
  ...
  >
    <div class="font-medium">
      ...
      <b class="font-philosopher text-xl text-[#CDA562]"
        >Amanah Sejahtera Bersama</b
      >
