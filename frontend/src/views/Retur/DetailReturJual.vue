...
<template>
  ...
  >
    ...
    >
      <span
        class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase my-a"
        >#</span
      >
    ...
    >
      ...
      <div class="text-center bg-white">
        ...
        <input
          ...
          id="pos-form-1"
          type="number"
          class="w-24 dark:bg-white form-control flex-1"
    ...
    >
      ...
      <div class="text-center bg-white sm:mt-auto mt-4">
        <textarea
          ...
          id="keterangan"
          v-model="keterangan"
          class="w-full dark:bg-white form-control flex-1"
      ...
      <div class="text-center p-auto sm:mt-auto mt-4">
        <div class="mb-2">
          <img
            decoding="async"
            loading="lazy"
            :src="getImgUrl(detail.gambar_bukti)"
            :alt="detail.gambar_bukti"
            class="w-10 m-auto rounded-md"
            width="100"
            height="100"
          />
        </div>
