  ...
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      ...
      >
        ...
        <ModalBody class="">
          <AccordionGroup class="accordion accordion-boxed w-full">
            <AccordionItem>
              <Accordion class="border-b"> Tambah Manual (1 Data)</Accordion>
              <AccordionPanel class="grid grid-cols-12 pt-5">
                        ...
                        <div class="overflow-hidden shadow sm:rounded-md">
                          <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                              <div
                                class="col-span-6 sm:col-span-3 form-switch mb-0"
                              >
                                <label
                                  for="inputIdVarian"
                              ...
                              >
                                <div
                                  :class="isEdit ? 'col-span-3' : 'col-span-6'"
                                >
                                  <label
                                    for="stokGlobal"
                                    class="block text-sm font-medium text-gray-700"
            ...
            <AccordionItem class="text-center">
              <Accordion class="border-b">
                Import dari File XLSX (>1 Data)</Accordion
              >
              <AccordionPanel class="pt-5">
                <p class="text-danger">
                  * Pastikan File Data Yang Anda kirim memiliki format sama
                  seperti contoh di bawah ini !!!
                </p>
                <div class="flex justify-center gap-5">
                  <a :href="example_varian" target="_blank" class="w-1/2">
                    <img
                      class="rounded-md"
                      alt="Amanah Sejahtera Bersama"
                      :src="example_varian"
                  ...
                  <a :href="example_barang" target="_blank" class="">
                    <img
                      class="rounded-md"
                      alt="Amanah Sejahtera Bersama"
                      :src="example_barang"
                ...
                <small class="">
                  * Klik pada Gambar Contoh Format Data Varian (kiri) dan Format
                  Data Barang (kanan) untuk memperbesar ukuran Gambar. <br />
                  Download template
                  <a
                    class="text-primary text-sm underline p-0.5 border-2 font-medium rounded hover:bg-slate-100"
                    href="/template_barang.xlsx"
                    download
                    >TEMPLATE BARANG</a
                  >
                  untuk contoh barang atau
                  <a
                    class="text-primary text-sm underline p-0.5 border-2 font-medium rounded hover:bg-slate-100"
                    href="/template_varian.xlsx"
                    download
                    >TEMPLATE VARIAN</a
                  >
                  untuk contoh varian.
                ...
                <div class="w-full justify-center">
                  <input
                    ...
                    accept=".xlsx"
                    ref="fileXLSX"
                    aria-label="Pilih file XLSX"
                    lang="id"
                    @change="importXlsxFile"
                    class="p-2 m-2 border-2 rounded hover:bg-orange-400 cursor-pointer overflow-hidden"
                  />

                  <button
                    v-if="isLoading2"
                    class="cursor-progress btn btn-primary w-32"
                  >
                ...
                <div id="tabulatorImport" ref="tableImportRef"></div>
              </AccordionPanel>
            </AccordionItem>
          </AccordionGroup>
        </ModalBody>
...
import example_barang from "@/assets/images/example_barang.png";
import example_varian from "@/assets/images/example_varian.png";
// import template_barang from "@/assets/template/template_barang.xlsx";
// import template_varian from "@/assets/template/template_varian.xlsx";

const Barang = useBarangStore();
const tableImportRef = ref();
const tabulatorImport = ref();
const fileXLSX = ref();
...
const resetModal = () => {
  ...
  if (tabulatorImport.value) {
    tabulatorImport.value.destroy(); // Menghancurkan tabel Tabulator yang ada sebelumnya
  }
  fileXLSX.value.value = null;
};
...
const importXlsxFile = function (event) {
...
const createTable = (data) => {
  ...
  tabulatorImport.value = new Tabulator(tableImportRef.value, {
    data: data,
    height: 311,
    layout: "fitColumns",
    autoColumns: true,
...
const saveFileData = async () => {
  try {
    if (fileData.value !== null) {
      await Barang.addMultiVarian(fileData.value);
      resetModal();
    } else {
      alert("File tidak boleh kosong");
    }
  } catch (error) {
    alert("Gagal Varian Tambah Multi Data", error);
  }
};
